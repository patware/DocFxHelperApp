...
namespace DocFxHelper.Core.Building
{
  public class AssemblyHelper(
    ILogger<AssemblyHelper> logger, 
    IFileSystem fileSystem, 
    ITocHelper tocHelper, 
    IEnumerable<IDocFxBuildSourceContributor> sourceContributors) : IAssemblyHelper
  {
    private readonly ILogger<AssemblyHelper> _logger = logger;
    ...
    public void CleanStaging(BuildPaths buildPaths)
    {
    ...
    public async Task LinkChildSourcesToParent(BuildPaths buildPaths, SiteGraph siteGraph, CancellationToken ct = default!)
    {
    ...
    public async Task SaveDocFxJsonAsync(BuildPaths buildPaths, JsonNode docFx, CancellationToken ct = default!)
    {
    ...
    public async Task<JsonNode> GenerateDocFxConfigAsync(BuildPaths buildPaths, SiteGraph siteGraph, CancellationToken ct = default!)
    {
    ...
    public void ProcessMustacheTemplates(BuildPaths buildPaths, SiteGraph siteGraph)
    {
    ...
    public void CopySourceToStaging(SiteNode siteNode, BuildPaths buildPaths)
    {
      string fromFolder;
